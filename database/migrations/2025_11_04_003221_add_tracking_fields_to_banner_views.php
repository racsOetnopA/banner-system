...
return new class extends Migration {
    ...
    {
        Schema::table('banner_views', function (Blueprint $table) {
            if (!Schema::hasColumn('banner_views', 'assignment_id')) {
                $table->foreignId('assignment_id')->nullable()->constrained()->nullOnDelete();
            }
            if (!Schema::hasColumn('banner_views', 'zone_id')) {
                $table->foreignId('zone_id')->nullable()->constrained()->nullOnDelete();
            }
            if (!Schema::hasColumn('banner_views', 'site_domain')) {
